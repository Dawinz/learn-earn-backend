...
export async function getTags(req: AuthenticatedRequest, res: Response) {
  try {
    const tags = await Lesson.aggregate([
      { $match: { isPublished: true } },
      { $unwind: '$tags' },
 ...
 * Search lessons
 */
export async function searchLessons(req: AuthenticatedRequest, res: Response) {
  try {
 ...
 */
export async function getAdminLessons(req: AuthenticatedRequest, res: Response) {
  try {
