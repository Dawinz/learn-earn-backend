...
const AdMobConfigSchema = new mongoose_1.Schema({
    platform: {
        type: String,
        enum: ['android', 'ios'],
        required: true,
...
exports.default = mongoose_1.default.model('AdMobConfig', AdMobConfigSchema);
//# sourceMappingURL=AdMobConfig.js.map